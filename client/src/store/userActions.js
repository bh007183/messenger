...
export const manageAccountAPI = () => apiCallBegan({
    url: `https://messenger-improved-bjh.herokuapp.com/api/manageAccount`,
    headers: {authorization: "Bearer: " + localStorage.getItem("token")},
    method: "GET",
...
export const deleteUserAPI = () => apiCallBegan({
    url: `https://messenger-improved-bjh.herokuapp.com/api/deleteUser`,
    headers: {authorization: "Bearer: " + localStorage.getItem("token")},
    method: "DELETE",
...
export const UpdateAccountAPI = (data) => apiCallBegan({
    url: `https://messenger-improved-bjh.herokuapp.com/api/updateUser`,
    headers: {authorization: "Bearer: " + localStorage.getItem("token")},
    method: "PUT",
    data: data,
    onSuccess: setManageAccount.type,
